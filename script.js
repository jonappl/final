...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Shortcut function for selecting a single element.
  const $ = (selector) => document.querySelector(selector);

  // Shortcut function for selecting multiple elements and converting them into an array.
  const $$ = (selector) => Array.from(document.querySelectorAll(selector));

  // List of allergy filter options used to build the checkbox UI.
  const allergyOptions = [
    ...
    // Shellfish allergy option.
    { id: "shellfish", label: "Shellfish" },

    // Tree nut allergy option.
    { id: "tree-nuts", label: "Tree nuts" },

    // Peanut allergy option.
    ...
    // Legume allergy option.
    { id: "legumes", label: "Legumes" },

    // Nightshade allergy option.
    { id: "nightshade", label: "Nightshades" },

    // Sulfites allergy option.
    { id: "sulfites", label: "Sulfites" },

    // Red meat restriction option.
    { id: "red-meat", label: "Red meat" },

    // Pork restriction option.
    { id: "pork", label: "Pork" }
  ];

  // Main recipe database.
  // Each object contains all information needed for rendering and filtering recipes.
  const recipes = [
